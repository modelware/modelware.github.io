...
title: OML Code
permalink: /oml-code
header_image: "/assets/images/bg/banner-6.png"
description: "Ontological Modeling Framework for rigorous, AI-enabled systems engineering."
---

{% include page_header.html %}

<div class="container text-center" style="margin-top: 12px; margin-bottom: 8px;">
    <img src="/assets/images/oml-code.png" alt="OML Code" style="max-height: 220px; width: auto; max-width: 100%;">
</div>
